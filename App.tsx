            ...
            <div className="grid grid-cols-2 gap-4">
              <div className={`p-4 rounded-2xl border transition-all ${isReadOnly ? 'bg-slate-100 border-slate-200' : 'bg-white border-emerald-100'}`}>
                ...
                <input 
                  ...
                  className={`w-full bg-transparent font-black text-lg outline-none ${isReadOnly ? 'text-slate-400 cursor-not-allowed' : 'text-slate-800'}`} 
                />
              </div>
              <div className={`p-4 rounded-2xl border transition-all ${isReadOnly ? 'bg-slate-100 border-slate-200' : 'bg-white border-emerald-100'}`}>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-5 text-sm h-28 outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 font-medium transition-all"
                />
              </div>
            </div>
          )}
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-slate-50 border border-slate-100 rounded-2xl px-6 py-5 text-sm h-32 outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 font-medium transition-all"
            />
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <aside className="lg:col-span-4 lg:sticky lg:top-32 h-fit space-y-8">
              <div className="bg-white p-10 rounded-2xl border border-slate-100">
                <h4 className="font-black text-slate-900 mb-8 uppercase tracking-[0.2em] text-[10px] border-b border-slate-50 pb-4">AI Engine Selection</h4>
